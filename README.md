# deb-maven-plugin [![Build Status](https://travis-ci.com/dernasherbrezon/deb-maven-plugin.svg?branch=master)](https://travis-ci.com/dernasherbrezon/deb-maven-plugin) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=com.aerse.maven%3Adeb-maven-plugin&metric=alert_status)](https://sonarcloud.io/dashboard?id=com.aerse.maven%3Adeb-maven-plugin)
